...
#include <stddef.h>
#include "robot_types/msg/detail/position__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  robot_types__msg__Position__init(message_memory);
}

void Position__rosidl_typesupport_introspection_c__Position_fini_function(void * message_memory)
{
  robot_types__msg__Position__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Position__rosidl_typesupport_introspection_c__Position_message_member_array[1] = {
  {
    ...
    offsetof(robot_types__msg__Position, position_vector),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Position__rosidl_typesupport_introspection_c__Position_message_members = {
  "robot_types__msg",  // message namespace
  "Position",  // message name
  1,  // number of fields
  sizeof(robot_types__msg__Position),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_types, msg, Position)() {
