...
#include "robot_types/msg/detail/position__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // position_vector
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // position_vector

// forward declare type support functions


using _Position__ros_msg_type = robot_types__msg__Position;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: position_vector
  {
    size_t size = ros_message->position_vector.size;
...
size_t get_serialized_size_robot_types__msg__Position(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name position_vector
  {
    size_t array_size = ros_message->position_vector.size;
    auto array_ptr = ros_message->position_vector.data;
...
static uint32_t _Position__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_types__msg__Position(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_types
size_t max_serialized_size_robot_types__msg__Position(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_robot_types__msg__Position(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_types, msg, Position)() {
