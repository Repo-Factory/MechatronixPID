...
#include "robot_types/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_types::msg::Position & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: position_vector
  {
    cdr << ros_message.position_vector;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_types::msg::Position & ros_message)
{
  // Member: position_vector
  {
    cdr >> ros_message.position_vector;
  ...
  size_t current_alignment)
{
  ...
  // Member: position_vector
  {
    ...
    size_t item_size = sizeof(ros_message.position_vector[0]);
...
{
  auto typed_message =
    static_cast<const robot_types::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_types::msg::Position *>(
    untyped_ros_message);
...
{
  return &robot_types::msg::typesupport_fastrtps_cpp::_Position__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_types, msg, Position)() {
  return &robot_types::msg::typesupport_fastrtps_cpp::_Position__handle;
}
